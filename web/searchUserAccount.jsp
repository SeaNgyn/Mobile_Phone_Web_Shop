                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="container mt-5">
                                <!-- Navbar Search-->
                                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="searchuseraccount">
                                ...
                                <a href="#"><button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addEditAdminModal">Add New user</button></a>
                                <h2 class="mb-4 mt-5">Customer Management</h2>
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.datacus}" var="c">    
                                            <tr>
                                                ...
                                                <td>${c.address}</td>
                                                <td>${c.createdOn}</td>
                                                <td><a href="updatecusadmin?cid=${c.customerId}"><button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#addEditCustomerModal">Update</button></a>
                                                    <a href="deletecusadmin?cid=${c.customerId}"><button class="btn btn-danger btn-sm">Delete</button></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class="paging">
                                                <c:forEach begin="1" end="${end}" var="i">
                                                    <a href="searchuseraccount?index=${i}&search=${search}">${i}</a>
                                                </c:forEach>
                                            </div>
                            </div>
                        </div>
