                        ...
                        <div class="col-lg-4">
                            <div class="checkout-inner">
                                <div class="coupon-container" style="display: none" id="couponInput_display">
                                    <div class="coupon">
                                        <input class="coupon-input" id="couponInput" type="text" placeholder="Discount code...">
                                    </div>
                                </div>
                                ...
                                <div class="checkout-summary">
                                    ...
                                    <p class="#" id="discountCode" style="display: none">Discount Cost<span id="discountCostDisplay"> 0 ₫</span></p>
                                    ...
                                    <div class="payment-methods" id="payment-methods-id" style="display: none">
                                        ...
                                        <div class="payment-method">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="payment-3">Cash On Delivery (COD)</label>
                                            </div>
...
//---------------------------------------------------------------------------------------------------------------------------------------------                
                                        ...
                                        function calculateDistanceBetweenAddresses(address1, address2, discount) {
                                            geocodeAddress(address1, function (coordinates1) {
                                                geocodeAddress(address2, function (coordinates2) {
                                                    ...
                                                    const total = ${not empty o.getTotalMoney() ? o.getTotalMoney() : 0};
                                                    ...
                                                    console.log('Shipping On/Off(1):', discount);
                                                    ...
                                                    $("#discountCostDisplay").text('-' + discountMoney.toLocaleString('vi-VN', {style: 'currency', currency: 'VND'}));
                                        ...
                                        function funtioncToProcess() {
                                            document.getElementById("couponInput_display").style.display = 'none';
                                            ...
                                            calculateDistanceBetweenAddresses(originAddress, destinationAddress, 1);
...
//API address--------------------------------------------------------------------------------------------------------------------------------
                                        ...
                                        var renderProvince = function (data, select) {
                                            let options = '<option value="" selected>Select province</option>';
                                        ...
                                        var renderWard = function (data, select) {
                                            let options = '<option value="" selected>Select ward</option>';
                                            data.forEach(element => {
