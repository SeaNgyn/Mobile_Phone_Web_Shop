                        ...
                        <div class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="container mt-5">
                                    ...
                                    <a href="add-admin.jsp"><button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addEditAdminModal">Add New Admin</button></a>
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>No</th>
...
<!--                                                <th>Password</th>-->
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${requestScope.dataadmin}" var="a">
...
<!--                                                    <td>${a.password}</td>-->
                                                    ...
                                                    <td>${a.createdName}</td>
                                                    <td>
                                                        <c:set var="dateString" value="${a.createdOn}" />
                                                    ...
                                                    <td><a href="updatea?adminId=${a.adminId}"><button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#addEditCustomerModal">Update</button></a>
                                                        <a href="deletea?id=${a.adminId}"><button class="btn btn-danger btn-sm">Delete</button></a>
                                                    </td>
                                                </tr>
                                            </c:forEach> 
                                        </tbody>
