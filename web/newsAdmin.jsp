                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <c:if test="${not empty sessionScope.adminAcc}">
                            ...
                            <div class="mb-4">
                                <a href="AddNewsAdmin"><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addProductModal">Addnews</button></a>
                            </div>
                        </c:if>
                        ...
                        <c:if test="${not empty sessionScope.adminAcc}">
                            ...
                            <div class="card mb-4">
                                ...
                                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="listnewsadmin?service=searchNews" method="post">
                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="Search for..." name="searchNews" aria-label="Search for..."
                                               aria-describedby="btnNavbarSearch" />
                                ...
                                <ul class="news-menu margin-bottom-20"> 
                                    <li class="news-menu__item">
                                        <a class="news-menu__link" href="listnewsadmin?service=getAll" >Tất cả</a>
                                    </li> 
                                    <c:forEach  items="${requestScope.newsgroup}" var="g">
                                        <li class="news-menu__item">
                                            <a class="news-menu__link" href="listnewsadmin?service=getById&grId=${g.newsGroupId}">${g.newsGroupName}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <div class="news-card row">
                                                <c:forEach items="${requestScope.listNew}" var="n">
                                                    <div class="col-md-3">
                                                        <a href="#">
                                                            <img class="img-fluid rounded" src="img2/${n.image}" alt="">
                                                        </a>
                                                    </div>
                                ...
                                <div class="paging">
                                    ...
                                    <c:forEach begin="1" end="${end}" var="i">                                      
                                        <a class="page-link" href="listnewsadmin?index=${i}&service=${ser != null ? ser : 'Checkagain'}&grId=${gr}&searchNews=${textSearch}">
                                            ${i}
                                        </a>                                     
                                    </c:forEach>
                                </div>
