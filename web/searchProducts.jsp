                        ...
                        <c:if test="${not empty sessionScope.adminAcc}">
                            ...
                            <div class="card mb-4">
                                ...
                                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="searchproductadmin">
                                    <div class="input-group">
                                        <input class="form-control" type="text" value="${search}" placeholder="Search for..." name="search" aria-label="Search for..."
                                               aria-describedby="btnNavbarSearch" />
...
<!--                                                    <td style="width: 25%">${p.description}</td>-->
                                    ...
                                    <div class="paging">
                                        <c:forEach begin="1" end="${end}" var="i">
                                            <a href="searchproductadmin?index=${i}&search=${search}">${i}</a>
                                        </c:forEach>
                                    </div>
