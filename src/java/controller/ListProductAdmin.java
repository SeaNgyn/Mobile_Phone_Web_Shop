 ...
 * @author nobod
 */
@WebServlet(name = "ListProductAdmin", urlPatterns = {"/listp"})
public class ListProductAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Category> cate = cateDao.getAllCategory();
            request.setAttribute("brand", cate);
            int count = dao.count();
            int pageSize = 20;
            int endPage = 0;
            ...
            List<Product> list = dao.getProductEachPage(index, pageSize);        
