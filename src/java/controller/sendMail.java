 ...
 * @author Admin
 */
@WebServlet(name = "testMail", urlPatterns = {"/sendmail"})
public class sendMail extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String account = request.getParameter("dataAccount");
        String action = request.getParameter("registerSuccess");
...
//        String cusPass = request.getParameter("cusPass");
        try {
            if (action != null) {
                emailRegister sendRes = new emailRegister();
                String[] parts = account.split(" ");
                String user = parts[0];
                String pass = parts[1];
                sendRes.sendMailRegister(email, user, pass);
            } else {
