 ...
 * @author nobod
 */
@WebServlet(name = "UpdateAdmin", urlPatterns = {"/updatea"})
public class UpdateAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Admin anew = dao.getCategoryById(adminID);
            ...
            anew.setEmail(email);
            anew.setModifiedBy(a.getAdminId());
            anew.setModifiedOn(date);
            dao.update(anew);
