 ...
 * @author nobod
 */
@WebServlet(name="ListUserAcount", urlPatterns={"/listuaccount"})
public class ListUserAcount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            List<Customer> list = dao.getCustomerEachPage(index, pageSize);        
